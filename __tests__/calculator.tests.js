...
describe('me', () => {
  ...
  test('lifeExpectancyRemainingVenusYears should be equal to 76', () => {
    const me = new Me (32)
  ...
  test('lifeExpectancyRemainingNeptuneYears should be equal to 0', () => {
    const me = new Me (32)
    expect(me.lifeExpectancyRemainingNeptuneYears).toEqual(0);
  });
});